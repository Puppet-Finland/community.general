...
options:
    state:
        description:
            ...
            - On C(present), the custom policy will be created (or updated if it exists already).
            - On C(absent), the custom policy will be removed if it exists.
    ...
    client_id:
        description:
            - The C(clientId) of the Keycloak client that should have the custom policy attached to it.
